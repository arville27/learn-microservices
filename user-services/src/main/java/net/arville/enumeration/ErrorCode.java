...
public enum ErrorCode {
    ...
    NO_USER_FOUND("APP-99-014", "Pengguna tidak dapat ditemukan", "User not found"),
    ...
    NO_BOOK_FOUND("APP-99-018", "Buku tidak dapat ditemukan", "Book not found"),
    EMAIL_ALREADY_USED("APP-99-019", "Email telah digunakan", "Email already used"),
    USER_ALREADY_HAS_THE_BOOK("APP-99-020", "Pengguna telah memiliki buku tersebut", "Email already has this book"),
